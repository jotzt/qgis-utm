...
<qgis version="2.14.2-Essen" minimumScale="-4.65661e-10" maximumScale="100100" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{2877d285-78b4-442d-b31b-d50b533f1363}">
      <rule filter="type IN ('rail')" key="{4ad3ebba-5801-4d36-82a3-1a17df514946}" symbol="0" label="railway track"/>
    </rules>
    <symbols>
