...
<qgis version="2.14.2-Essen" minimumScale="-4.65661e-10" maximumScale="500100" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{348ac064-d006-4bc9-94a2-50cd5ca7fdb0}">
      <rule filter="&quot;type&quot; = 'residential'" key="{a3a1b448-ea34-492f-941d-fee2ab01dbd0}" symbol="0" label="residential"/>
      <rule checkstate="0" filter="&quot;type&quot;IN ('allotments', 'farm', 'farmland', 'farmyard')" key="{e6310c96-4a52-4273-a184-796be9ecef5e}" symbol="1" label="allotments, farm, farmland, farmyard"/>
      <rule filter="&quot;type&quot; IN ( 'cemetery', 'grave_yard')" key="{4dabb794-8057-4ab8-b1d3-278249fb0669}" symbol="2" label="cemetery"/>
      <rule filter="&quot;type&quot; IN ('retail')" key="{d32b6c29-8c0a-402b-861d-dd90d2615103}" symbol="3" label="Retail"/>
      <rule filter="&quot;type&quot; IN ('industrial')" key="{44b9cf0a-6337-4b8f-9e06-ee0a82a3769f}" symbol="4" label="Industrial"/>
      <rule filter="&quot;type&quot; IN ('commercial')" key="{d3e8b190-0f28-468b-a7df-f5283283100e}" symbol="5" label="Commercial"/>
      <rule filter="&quot;type&quot; = 'conservation'" key="{f9168309-07c8-4fd8-be22-8bdcbc7ac99d}" symbol="6" label="conservation"/>
      <rule filter="&quot;type&quot; IN( 'grass', 'grassland', 'village_green', 'park')" key="{b5bb7e11-ad0e-44ca-8b48-739405a85a60}" symbol="7" label="grass, grassland, village green, park"/>
      <rule filter="&quot;type&quot; = 'greenhouse_horticulture'" key="{9688ab0e-8183-4720-853f-a81f50b30df7}" symbol="8" label="greenhouse horticulture"/>
      <rule checkstate="0" filter="&quot;type&quot; = 'meadow'" key="{dd95e763-25e6-4bc5-bb19-522f7fda3fab}" symbol="9" label="meadow"/>
      <rule filter="&quot;type&quot; = 'military'" key="{793a5e8d-04eb-4c17-bc3d-855170e5595b}" symbol="10" label="military"/>
      <rule filter="&quot;type&quot; = 'orchard'" key="{28ca047d-4b66-4c47-8366-55bc11b2e32b}" symbol="11" label="orchard"/>
      <rule filter="&quot;type&quot; = 'vineyard'" key="{e2e62642-36b4-4886-8250-d829d0398828}" symbol="12" label="vineyard"/>
      <rule filter="&quot;type&quot; = 'quarry'" key="{23c683ea-3b58-443c-ba2c-db786b827d9f}" symbol="13" label="quarry"/>
      <rule filter="&quot;type&quot; = 'landfill'" key="{5ec26619-55b3-4102-8d5c-c412391f77cf}" symbol="14" label="landfill"/>
      <rule filter="&quot;type&quot; = 'recreation_ground'" key="{3b3b3e28-d7c2-4e7c-b817-a385ca458f73}" symbol="15" label="recreation ground"/>
      <rule filter="&quot;type&quot; IN ('school', 'education')" key="{2a4d4c23-fdc5-4800-bf37-5a4cf62915d7}" symbol="16" label="school, education"/>
      <rule filter="&quot;type&quot; IN ('wood', 'forest')" key="{7f21e265-d174-4069-b414-c5aaee1b95a2}" symbol="17" label="wood, forest"/>
      <rule filter="&quot;type&quot;IN ('aquaculture', 'basin', 'reservoir', 'pool')" key="{f96800c2-3f61-42ed-a825-28dbf0c90719}" symbol="18" label="aquaculture, basin, reservoir, pool"/>
      <rule filter="&quot;type&quot; = 'salt_pond'" key="{77af4e98-b1d9-4a15-96b7-dfe4be417562}" symbol="19" label="salt pond"/>
      <rule filter="&quot;type&quot; = 'harbour'" key="{35f1f5c1-3740-428c-b187-d7bbab9a9b17}" symbol="20" label="harbour"/>
      <rule filter="&quot;type&quot;  =  'pitch'" key="{ddcbd444-a095-4536-8cae-2bee85ac7f69}" symbol="21" label="pitch"/>
    </rules>
    <symbols>
